...
export function SubmitPropertyButton() {
  return (
    <Link href="/submit-property" className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium",
      "transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
      "disabled:pointer-events-none disabled:opacity-50",
      "bg-white text-primary hover:bg-gray-100", // White background, dark text, slight hover
      "h-9 px-4 py-2" // Standard button size
    )}>
